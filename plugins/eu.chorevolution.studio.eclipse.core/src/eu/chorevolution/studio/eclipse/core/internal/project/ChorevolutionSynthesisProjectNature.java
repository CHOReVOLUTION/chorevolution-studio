...
public class ChorevolutionSynthesisProjectNature implements IProjectNature {

    public static final String PREF_SYNTHESIS_PROCESSOR_RUN_EMBEDDED ="synthesis.processor.run.embedded.property";
	 ...
	 */
	public ChorevolutionSynthesisProjectNature() {
	}
