...
public abstract class SynthesisProcessorAccessControl {
	private IProject project;
	private Map<String, ChorevolutionPreferenceData> propertyValues;

	public SynthesisProcessorAccessControl(IProject project) {
		this.project = project;
		propertyValues = (new ChorevolutionServicesURIPrefs()).readProjectOrWorkspacePreferences(project);
	}

	public abstract boolean executeLogin() throws Exception;
