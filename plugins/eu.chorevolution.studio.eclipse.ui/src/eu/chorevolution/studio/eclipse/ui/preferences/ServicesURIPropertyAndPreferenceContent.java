...
public class ServicesURIPropertyAndPreferenceContent {
    ...
    public ServicesURIPropertyAndPreferenceContent(Shell shell, IProject project) {
    ...
    public Control createContents(Composite parent) {
        ...
        beansLabel.setText(ChorevolutionUIMessages.ServiceURIProperty_description);
        ...
        /*
         * List<ChorevolutionPreferenceData> servicesURI = new
         * ArrayList<ChorevolutionPreferenceData>();
         * servicesURI.add(projectOrWorkspacePreferencesValues.get(
         * ChorevolutionServicesURIPrefs.PREF_APACHE_SYNCOPE_URI)); if
         * (!ChorevolutionProjectUtils.isChorevolutionServiceThingProjectNature(
         * project)){ servicesURI.add(projectOrWorkspacePreferencesValues.get(
         * ChorevolutionServicesURIPrefs.PREF_REST_URL_ENACTMENT_ENGINE)); }
         * textWidgets.putAll(Utilities.createContents(composite, "Services URI"
         * , servicesURI));
         */

        List<ChorevolutionPreferenceData> apacheSyncopePrefs = new ArrayList<ChorevolutionPreferenceData>();
        apacheSyncopePrefs.add(projectOrWorkspacePreferencesValues.get(ChorevolutionServicesURIPrefs.PREF_APACHE_SYNCOPE_URI));
        apacheSyncopePrefs.add(projectOrWorkspacePreferencesValues.get(ChorevolutionServicesURIPrefs.PREF_APACHE_SYNCOPE_USERNAME));
        apacheSyncopePrefs.add(projectOrWorkspacePreferencesValues.get(ChorevolutionServicesURIPrefs.PREF_APACHE_SYNCOPE_PASSWORD));
        apacheSyncopePrefs.add(projectOrWorkspacePreferencesValues.get(ChorevolutionServicesURIPrefs.PREF_APACHE_SYNCOPE_DOMAIN));
        textWidgets.putAll(Utilities.createGrupContents(composite, "Apache Syncope", apacheSyncopePrefs));
