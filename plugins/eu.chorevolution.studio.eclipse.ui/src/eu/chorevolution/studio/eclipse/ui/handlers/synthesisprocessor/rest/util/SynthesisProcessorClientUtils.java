...
*/
package eu.chorevolution.studio.eclipse.ui.handlers.synthesisprocessor.rest.util;
...
public class SynthesisProcessorClientUtils {
	...
	public static byte[] getArtifactContent(SynthesisProcessorClient client, String location) throws SynthesisProcessorBusinessException {
		try {
