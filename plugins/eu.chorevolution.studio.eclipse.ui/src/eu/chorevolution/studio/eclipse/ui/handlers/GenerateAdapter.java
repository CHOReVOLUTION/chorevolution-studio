...
public class GenerateAdapter extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		while (iterator.hasNext()) {
			...
			MessageDialog.openInformation(ChorevolutionUIPlugin.getActiveWorkbenchShell(),
					ChorevolutionUIMessages.TransformatorORGeneator_Information,
					ChorevolutionUIMessages.Generator_adapterInformation);
